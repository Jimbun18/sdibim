...
@section('page_title', 'Formulir Mata Pelajaran Baru')
...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <h3 class="text-xl font-extrabold text-slate-900 tracking-tight">Formulir Mata Pelajaran Baru</h3>
            <p class="text-xs sm:text-sm text-slate-500 mt-0.5">Daftarkan kurikulum mata pelajaran, tetapkan KKM kelulusan, dan pilih guru pengampu.</p>
        </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5">
                    ...
                    <div>
                        ...
                        <input type="number" name="kkm" id="kkm" value="{{ old('kkm', 75) }}" min="0" max="100" required placeholder="75" class="w-full px-4 py-2.5 bg-slate-50 border @error('kkm') border-rose-300 ring-1 ring-rose-300 @else border-slate-300 @enderror rounded-xl text-sm focus:outline-hidden focus:ring-2 focus:ring-emerald-500 focus:bg-white transition-all">
                        @error('kkm')
                            <p class="text-xs text-rose-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <p class="text-[11px] text-slate-400 mt-1.5">
                            * Guru yang ditetapkan dapat mengakses modul Akademik untuk menginput nilai e-Rapor mapel ini.
                        </p>
                    </div>
                </div>
            </div>
