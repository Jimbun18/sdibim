...
@section('page_title', 'Formulir Siswa Baru')
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <h3 class="text-xl font-extrabold text-slate-900 tracking-tight">Formulir Pendaftaran Siswa</h3>
            <p class="text-xs sm:text-sm text-slate-500 mt-0.5">Lengkapi data pokok siswa untuk menghubungkannya secara otomatis ke rombongan belajar.</p>
        </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="nis" id="nis" value="{{ old('nis') }}" required placeholder="Contoh: 2026001" class="w-full px-3.5 py-2.5 bg-slate-50 border @error('nis') border-rose-300 ring-1 ring-rose-300 @else border-slate-300 @enderror rounded-xl text-sm text-slate-900 focus:outline-hidden focus:ring-2 focus:ring-emerald-500 focus:bg-white transition-all">
                        @error('nis')
                    ...
                    <div>
                        ...
                        <input type="text" name="nisn" id="nisn" value="{{ old('nisn') }}" placeholder="Contoh: 0012345678" class="w-full px-3.5 py-2.5 bg-slate-50 border @error('nisn') border-rose-300 ring-1 ring-rose-300 @else border-slate-300 @enderror rounded-xl text-sm text-slate-900 focus:outline-hidden focus:ring-2 focus:ring-emerald-500 focus:bg-white transition-all">
                        @error('nisn')
                            <p class="mt-1 text-xs text-rose-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="nama_siswa" id="nama_siswa" value="{{ old('nama_siswa') }}" required placeholder="Masukkan nama lengkap siswa..." class="w-full px-3.5 py-2.5 bg-slate-50 border @error('nama_siswa') border-rose-300 ring-1 ring-rose-300 @else border-slate-300 @enderror rounded-xl text-sm text-slate-900 focus:outline-hidden focus:ring-2 focus:ring-emerald-500 focus:bg-white transition-all">
                        @error('nama_siswa')
                            <p class="mt-1 text-xs text-rose-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-4 mt-2">
                            <label class="inline-flex items-center text-sm text-slate-700 cursor-pointer">
                                <input type="radio" name="jenis_kelamin" value="L" {{ old('jenis_kelamin', 'L') === 'L' ? 'checked' : '' }} class="w-4 h-4 text-emerald-600 focus:ring-emerald-500 border-slate-300">
                                <span class="ml-2 font-medium">Laki-laki (Ikhwan)</span>
                            </label>
                            <label class="inline-flex items-center text-sm text-slate-700 cursor-pointer">
                                <input type="radio" name="jenis_kelamin" value="P" {{ old('jenis_kelamin') === 'P' ? 'checked' : '' }} class="w-4 h-4 text-emerald-600 focus:ring-emerald-500 border-slate-300">
                    ...
                    <div>
                        ...
                        <label class="inline-flex items-center mt-2 cursor-pointer">
                            <input type="checkbox" name="status_aktif" value="1" {{ old('status_aktif', '1') ? 'checked' : '' }} class="w-4 h-4 text-emerald-600 rounded-sm focus:ring-emerald-500 border-slate-300">
            ...
            <div class="pt-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_wali" id="nama_wali" value="{{ old('nama_wali') }}" placeholder="Contoh: Bapak Ahmad / Ibu Fatimah" class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-300 rounded-xl text-sm text-slate-900 focus:outline-hidden focus:ring-2 focus:ring-emerald-500 focus:bg-white transition-all">
                    </div>

                    <!-- No HP / WhatsApp -->
                    <div>
                        <label for="no_hp_wali" class="block text-xs font-semibold text-slate-700 mb-1.5">No. WhatsApp / Telepon Wali</label>
                        <input type="text" name="no_hp_wali" id="no_hp_wali" value="{{ old('no_hp_wali') }}" placeholder="08xxxxxxxxxx" class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-300 rounded-xl text-sm text-slate-900 focus:outline-hidden focus:ring-2 focus:ring-emerald-500 focus:bg-white transition-all">
                    </div>

                    <!-- Alamat Lengkap -->
                    <div class="sm:col-span-2">
                        <label for="alamat" class="block text-xs font-semibold text-slate-700 mb-1.5">Alamat Tempat Tinggal</label>
                        <textarea name="alamat" id="alamat" rows="3" placeholder="Nama jalan, nomor rumah, RT/RW, kelurahan, kecamatan..." class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-300 rounded-xl text-sm text-slate-900 focus:outline-hidden focus:ring-2 focus:ring-emerald-500 focus:bg-white transition-all">{{ old('alamat') }}</textarea>
                    </div>
                </div>
            </div>
