        ...
        <div x-data="{ showPassword: false }">
            ...
            <div class="relative">
                ...
                <input
                    ...
                    placeholder="••••••••"
                    class="w-full pl-10 pr-11 py-2.5 bg-slate-950/70 border border-slate-700 rounded-xl text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all"
                >
                <button
                    type="button"
                ...
                >
                    ...
                    <!-- Eye Off / Slash Icon (Password shown, click to hide) -->
